"""
TranscriptIQ - PyQt5 Desktop Application
...
class TranscripIQMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("TranscripIQ - AI Desktop Application")
...
class TranscripIQApp(QApplication):
    """Main application class"""
    
    def __init__(self, argv):
        super().__init__(argv)
        self.setApplicationName("TranscripIQ")
        self.setApplicationVersion("2.0")
        self.setOrganizationName("TranscripIQ AI")
        ...
        if os.path.exists(icon_path):
            ...
            try:
                import ctypes
                myappid = 'transcripiq.ai.transcription.2.0'  # Unique App ID
                ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID(myappid)
            except Exception:
                pass  # Continue if Windows-specific code fails
        
        # Create and show main window
        self.main_window = TranscripIQMainWindow()
        self.main_window.show()

def main():
    """Main entry point"""
    app = TranscripIQApp(sys.argv)
