...
Monitors and prevents storage accumulation for TranscripIQ
"""
            ...
            for ext in self.monitored_extensions:
                ...
                for file_path in files:
                    if os.path.isfile(file_path):
                        ...
                        if any(keyword in filename.lower() for keyword in ['transcripiq', 'temp_audio', 'whisper']):
    ...
    def force_immediate_cleanup(self) -> Dict[str, int]:
        ...
        try:
            patterns = [
                ...
                os.path.join(self.temp_dir, "*transcripiq*"),
