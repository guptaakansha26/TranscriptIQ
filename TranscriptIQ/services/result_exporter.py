...
class ResultExporter:
    ...
    def save_as_pdf(self, content: str, output_path: str) -> None:
        ...
        try:
            ...
            # Add title
            story.append(Paragraph("TranscripIQ - Exported Results", title_style))
    ...
    def save_as_text(self, content: str, output_path: str) -> None:
        ...
        try:
            with open(output_path, 'w', encoding='utf-8') as f:
                f.write("TRANSCRIPIQ - EXPORTED RESULTS\n")
                f.write("=" * 50 + "\n\n")
    ...
    def save_as_word(self, content: str, output_path: str) -> None:
        ...
        try:
            ...
            # Add title
            title = doc.add_heading('TranscripIQ - Exported Results', level=1)
    ...
    def create_export_filename(self, base_name: str, format_ext: str) -> str:
        ...
        return f"TranscripIQ_{clean_base}_{timestamp}{format_ext}"
